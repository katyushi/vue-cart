  ...
  <div class="container">
    <nav class="bg-white px-8 pt-2 shadow-md">
        <div class="-mb-px flex justify-center">
          ...
          <router-link to="/cart" class="no-underline text-grey-dark border-b-2 border-transparent uppercase tracking-wide font-bold text-xs py-3 mr-8">Cart</router-link>
        </div>
    </nav><br />
