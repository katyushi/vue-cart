                ...
                return (
                    ...
                    k.each(function(k) {
                        ...
                        if (
                            ...
                            o &&
                                B.selectAll('text').attr('transform', function(
                                    a,
                                    b,
                                    c
                                ) {
                ...
                return (
                    ...
                    l.each(function(l) {
                        ...
                        if (
                            ...
                            for (P in y)
                                z[P] =
                                    y[P] instanceof Array ? y[P].slice(0) : y[P]
                        }
                        var Q = d3.behavior
                            .drag()
                            .on('dragstart', A)
                ...
                return (
                    b.each(function(k) {
                        ...
                        if (
                            ...
                            for (D in u)
                                v[D] =
                                    u[D] instanceof Array ? u[D].slice(0) : u[D]
                        }
                        if (
                            !(
                                k &&
                ...
                return (
                    ...
                    j.each(function(j) {
                        ...
                        if (
                            ...
                            for (D in t)
                                u[D] =
                                    t[D] instanceof Array ? t[D].slice(0) : t[D]
                        }
                        if (
                            !(
                                j &&
                ...
                return (
                    v.each(function(v) {
                        ...
                        if (
                            ...
                            for (Y in M)
                                N[Y] =
                                    M[Y] instanceof Array ? M[Y].slice(0) : M[Y]
                        }
                        if (
                            !(
                                v &&
                        ...
                        d.range([0, V]),
                            e
                                .domain(
                                    d3.extent(d3.merge(_.concat(ab)), function(
                                        a
                                    ) {
                                        return a.x
                                    })
                ...
                return (
                    o.each(function(o) {
                        ...
                        if (
                            ...
                            for (N in C)
                                D[N] =
                                    C[N] instanceof Array ? C[N].slice(0) : C[N]
                        }
                        if (
                            !(
                                o &&
                ...
                return (
                    ...
                    j.each(function(j) {
                        ...
                        if (
                            ...
                            for (I in x)
                                y[I] =
                                    x[I] instanceof Array ? x[I].slice(0) : x[I]
                        }
                        if (
                            !(
                                j &&
                        ...
                        if ((N.call(e), r)) {
                            ...
                            if (
                                ...
                                var P = function(a, b) {
                                    ...
                                    Q = 5,
                                    R = 17
                                O.selectAll('text').attr('transform', function(
                                    a,
                                    b,
                                    c
                                ) {
                ...
                return (
                    ...
                    j.each(function(j) {
                        ...
                        if (
                            ...
                            for (E in u)
                                v[E] =
                                    u[E] instanceof Array ? u[E].slice(0) : u[E]
                        }
                        if (
                            !(
                                j &&
                ...
                return (
                    j.each(function(j) {
                        ...
                        p
                            .domain(
                                c ||
                                    d3.extent(d3.merge(L).concat(Z), function(
                                        a
                                    ) {
                                        return a.y
                                    })
                ...
                return (
                    ...
                    e.each(function(e) {
                        ...
                        if (
                            ...
                            for (q in l)
                                m[q] =
                                    l[q] instanceof Array ? l[q].slice(0) : l[q]
                        }
        ...
        (a.models.scatter = function() {
            ...
            return (
                ...
                L.on('elementMouseover.point', function(a) {
                    w &&
                        b._calls.highlightPoint(a.seriesIndex, a.pointIndex, !0)
                }),
                L.on('elementMouseout.point', function(a) {
                    w &&
                        b._calls.highlightPoint(a.seriesIndex, a.pointIndex, !1)
                }),
                (b._options = Object.create(
                    {},
                    {
                ...
                return (
                    ...
                    z.each(function(z) {
                        ...
                        if (
                            ...
                            for (I in w)
                                x[I] =
                                    w[I] instanceof Array ? w[I].slice(0) : w[I]
                        }
                        if (
                            !(
                                z &&
                        ...
                        P.enter()
                            ...
                            c.dispatch.on('elementMouseover.tooltip', function(
                                a
                            ) {
                                m
                                    .select(
                ...
                return (
                    ...
                    k.each(function(k) {
                        ...
                        if (
                            ...
                            for (M in v)
                                w[M] =
                                    v[M] instanceof Array ? v[M].slice(0) : v[M]
                        }
                        if (
                            !(
                                k &&
